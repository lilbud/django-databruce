# Generated by Django 5.1.7 on 2025-07-21 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.TextField(blank=True, db_column='event_date_note', default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(blank=True, db_column='release_name', default=None)),
                ('brucebase_id', models.TextField(blank=True, default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('state_abbrev', models.TextField(blank=True, default=None, unique=True)),
                ('name', models.TextField(blank=True, default=None)),
                ('num_events', models.IntegerField(default=0)),
                ('mbid', models.TextField(blank=True, default=None)),
                ('updated_at', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_events', models.IntegerField(default=0)),
                ('aliases', models.TextField(blank=True, default=None)),
                ('mbid', models.TextField(blank=True, db_column='mb_id', default=None)),
                ('updated_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
            ],
            options={
