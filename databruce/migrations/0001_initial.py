# Generated by Django 6.0.2 on 2026-07-06 20:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        blank=True, db_column="event_date", default=None, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "note",
                    models.TextField(
                        blank=True, db_column="song_note", default=None, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("tour_leg_num", models.IntegerField(blank=True, null=True)),
                ("tour_leg_total", models.IntegerField(blank=True, null=True)),
                ("run_num", models.IntegerField(blank=True, null=True)),
                ("run_total", models.IntegerField(blank=True, null=True)),
                ("venue_num", models.IntegerField()),
                ("venue_total", models.IntegerField()),
                ("city_num", models.IntegerField()),
                ("city_total", models.IntegerField()),
                ("length_rank", models.IntegerField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gap",
                    models.IntegerField(blank=True, db_column="calc_gap", null=True),
                ),
                (
                    "premiere",
                    models.BooleanField(blank=True, db_column="is_premiere", null=True),
                ),
                (
                    "debut",
                    models.BooleanField(blank=True, db_column="is_debut", null=True),
                ),
                (
                    "band_premiere",
                    models.BooleanField(
                        blank=True, db_column="is_band_premiere", null=True
                    ),
                ),
                (
                    "tour_num",
                    models.IntegerField(blank=True, db_column="tour_num", null=True),
                ),
                (
                    "tour_total",
                    models.IntegerField(blank=True, db_column="tour_total", null=True),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.TextField(
                        blank=True, db_column="archive_url", default=None, null=True
                    ),
                ),
                (
                    "event",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="posts",
                through="databruce.BlogPostTags",
                to="databruce.blogtags",
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.TextField(db_column="cover_url", default=None, unique=True),
                ),
                (
                    "event",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.TextField(db_column="thumbnail_url", default=None),
                ),
                ("name", models.TextField(blank=True, default=None, null=True)),
                (
                    "first_friday",
                    models.BooleanField(db_column="first_friday", default=False),
                ),
                (
                    "event",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "show_cal",
                    models.BooleanField(db_column="show_calendar", default=False),
                ),
                (
                    "first_event",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "format",
                    models.CharField(
                        choices=[("audio", "audio"), ("video", "video")], default=None
                    ),
                ),
                (
                    "date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.TextField(
                        db_column="song_name", default=None, verbose_name="Name"
                    ),
                ),
                (
                    "short_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "num",
                    models.TextField(
                        blank=True, db_column="version_num", default=None, null=True
                    ),
                ),
                (
                    "source",
                ...
                (
                    "text",
                    models.TextField(
                        blank=True, db_column="lyrics", default=None, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "abbrev",
                    models.TextField(
                        db_column="state_abbrev", default=None, unique=True
                    ),
                ),
                ("name", models.TextField(blank=True, default=None, null=True)),
                ("num_events", models.IntegerField(default=0)),
