    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.TextField(blank=True, db_column="archive_url", null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "brucebase_url",
                    models.TextField(blank=True, default=None, unique=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.TextField(
                        blank=True, db_column="continent_name", default=None
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.TextField(
                        blank=True, db_column="cover_url", default=None, unique=True
                    ),
                ),
                ("updated_at", models.DateTimeField(auto_now_add=True, null=True)),
                ("created_at", models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.TextField(
                        db_column="event_id", primary_key=True, serialize=False
                    ),
                ),
                (
                    "date",
                    models.DateField(blank=True, db_column="event_date", default=None),
                ),
                (
                    "early_late",
                    models.CharField(
                ...
                (
                    "title",
                    models.TextField(blank=True, db_column="event_title", default=None),
                ),
                (
                    "event_certainty",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        blank=True, db_column="release_date", default=None
                    ),
                ),
                (
                    "url",
                    models.TextField(blank=True, db_column="nugs_url", default=None),
                ),
                (
                    "thumbnail",
                    models.TextField(
                        blank=True, db_column="thumbnail_url", default=None
                    ),
                ),
                ("name", models.TextField(blank=True, default=None)),
                ("updated_at", models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "band_premiere",
                    models.BooleanField(db_column="band_premiere", default=False),
                ),
                ("position", models.TextField(blank=True, default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "note",
                    models.TextField(
                        blank=True, db_column="snippet_note", default=None
                    ),
                ),
                ("updated_at", models.DateTimeField(auto_now_add=True, null=True)),
                ("created_at", models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_name",
                    models.TextField(
                        blank=True, default=None, verbose_name="Short Name"
                    ),
                ),
                (
                    "num_plays_public",
                ...
                (
                    "original_artist",
                    models.TextField(
                        blank=True, default=None, verbose_name="Original Artist"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "abbrev",
                    models.TextField(
                        blank=True, db_column="state_abbrev", default=None, unique=True
                    ),
                ),
                ("name", models.TextField(blank=True, default=None)),
                ("num_events", models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.TextField(blank=True, db_column="tour_name", default=None),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.TextField(blank=True, db_column="to_value", null=True),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, null=True)),
