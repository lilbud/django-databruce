...
urlpatterns = [
  ...
  path("tours/<str:slug>", TourDetailView.as_view(), name="tour_details"),
  ...
  re_path("^runs/?$", EventRunView.as_view(), name="runs"),
  path("runs/<str:slug>", RunDetailView.as_view(), name="run_details"),
  path("tour_legs", TourLegView.as_view(), name="tour_legs"),
  path("tour_legs/<str:slug>", TourLegDetailView.as_view(), name="leg_details"),
  path("nugs_releases", NugsReleaseView.as_view(), name="nugs_releases"),
  path("bootlegs", BootlegView.as_view(), name="bootlegs"),
  path(
